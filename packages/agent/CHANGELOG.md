...
- **Renamed PyPI distribution** from `dragent` to `anygarden-agent` —
  ...
  path (`anygarden_agent`), CLI commands (`anygarden-agent`,
  `anygarden-client`), and source directory unchanged.

## v0.7.0 (2026-05-20)

### Release infrastructure

- **Renamed PyPI distribution** from `anygarden-agent` to `dragent`
...
- OpenHands: capture user-facing reply from `FinishAction` tool path
  ([#375](https://github.com/e7217/anygarden/pull/375)).
- OpenHands: capture assistant text from `MessageEvent.llm_message`
  ([#372](https://github.com/e7217/anygarden/pull/372),
  [#373](https://github.com/e7217/anygarden/pull/373)).
- OpenHands: pass `api_key` explicitly so the LLM caches the right
  token ([#366](https://github.com/e7217/anygarden/pull/366),
  [#367](https://github.com/e7217/anygarden/pull/367)).
...
- Lift memory/roster injection from per-engine adapters to the
  `EngineAdapter` base
  ([#295](https://github.com/e7217/anygarden/pull/295)).
...
- Orchestrator agent + `handoff` tool + per-agent token
  UI ([#178](https://github.com/e7217/anygarden/pull/178))
...
- Decouple context ingestion from response gate (#74)
  ([#139](https://github.com/e7217/anygarden/pull/139))
- Ambient context window for session engines (#74 Stage B)
  ([#141](https://github.com/e7217/anygarden/pull/141))
- Per-room `context_window_enabled` toggle (#148 Part 1)
  ...
  [#152](https://github.com/e7217/anygarden/pull/152)).
...
- Auto-approve MCP tool calls for all engines (#134)
  ([#137](https://github.com/e7217/anygarden/pull/137))

### Fixes

- `agent/gemini`: pass `--skip-trust` to bypass the
  trusted-folders gate (#261)
  ([#262](https://github.com/e7217/anygarden/pull/262))
- Sync room shared files on agent respawn & mid-session
  (#255) ([#256](https://github.com/e7217/anygarden/pull/256))
...
- Reset `_agent_turn_count` on self-emitted `[ROOM_QUERY]` /
  ...
  ([#67](https://github.com/e7217/anygarden/issues/67),
  [#69](https://github.com/e7217/anygarden/pull/69))
...
- Prevent duplicate `room_query_forward` from multi-agent rooms
  ([#61](https://github.com/e7217/anygarden/pull/61))
...
- Respect explicit @mention when routing human messages
  ([#36](https://github.com/e7217/anygarden/pull/36))
...
- Route id-based @mention tokens to the intended target
  ([#37](https://github.com/e7217/anygarden/pull/37))
...
- Switch license to Apache-2.0 and update author
  ([`613986b`](https://github.com/e7217/anygarden-agent/commit/613986b4cf30644928817a1b40f3578938e07888))
...
- Add python-semantic-release for automatic versioning
  ([`f51f2dd`](https://github.com/e7217/anygarden-agent/commit/f51f2dd96f7c3b1c286a7449d8cf82a3efdfbaae))

Co-Authored-By: Claude Opus 4.6 (1M context) <noreply@anthropic.com>

### Features

- Initial release — anygarden-agent v0.1.0
  ([`3e6e66a`](https://github.com/e7217/anygarden-agent/commit/3e6e66a9e5d34231fdf9a6d2e3d8e79c2649795a))

Extracted from e7217/anygarden monorepo (formerly anygarden-sdk). Renamed package anygarden_sdk →
  anygarden_agent for clarity.

Includes: - ChatClient (WebSocket + REST) - 6 engine adapters (OpenAI, Anthropic, Claude Code,
  Codex, Gemini CLI, Deep Agents) - CLI entry points (anygarden-agent, anygarden-client) - Agent profile
