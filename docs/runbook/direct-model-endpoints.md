...
An administrator can connect an individual agent to a local or custom HTTP model server from **Agent settings → Overview → Configure direct model connection**.
